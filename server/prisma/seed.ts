...
const roleSeed = [
  ...
  {
    name: "Receptionist",
    description: "Appointment and front-desk operations",
  },
...
const permissions = [
  ...
  { resource: "facility", action: "update" },
  { resource: "facility", action: "delete" },
  ...
  for (const role of allRoles) {
    ...
    switch (roleName) {
      case "SuperAdmin":
        ...
        break;
      case "HospitalAdmin":
        assignments.set("facility:read", true);
        assignments.set("facility:update", true);
        assignments.set("department:create", true);
        assignments.set("department:read", true);
        assignments.set("department:update", true);
        assignments.set("department:delete", true);
        assignments.set("user:create", true);
        assignments.set("user:update", true);
        assignments.set("user:read", true);
